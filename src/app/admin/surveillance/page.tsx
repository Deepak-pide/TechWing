...
import { Layers, PlayCircle, Maximize } from "lucide-react";
    ...
    <div className="container mx-auto p-4 md:p-8">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Define an area on the map to begin a surveillance mission.</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="relative aspect-video w-full rounded-lg overflow-hidden border">
            <Image
              src="https://images.unsplash.com/photo-1599839603058-2d79a29d3c10?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
              alt="Map of farmland"
              fill
